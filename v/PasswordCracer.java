...
public class PasswordCracer {
    public static void main(String[] args) throws FileNotFoundException {
        Scanner scMap = new Scanner(new File("v/inputMap.txt"));
        Scanner scDir = new Scanner(new File("v/inputDirections.txt"));

        ArrayList<String> input = new ArrayList<>();
        Integer direction = 0;
        Integer inputWidth = 0;
        Integer indexX = 0; // 0 for example
        Integer indexY = 0; // 8 for example, 49 for real
        Integer findX = 0;
        Integer findY = 0;
        ...
        try {
            TwoDArrayUtils.TwoDCharArrayToFile(map, "v/test.txt");
        } catch (IOException e) {
            e.printStackTrace();
        }
